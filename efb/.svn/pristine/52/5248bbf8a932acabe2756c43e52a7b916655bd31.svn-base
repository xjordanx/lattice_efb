...
component efb
    port (wb_clk_i: in  std_logic; wb_rst_i: in  std_logic; 
        ...
        spi_irq: out  std_logic; tc_clki: in  std_logic; 
        tc_rstn: in  std_logic; tc_ic: in  std_logic; 
        tc_int: out  std_logic; tc_oc: out  std_logic; 
...
__ : efb
    port map (wb_clk_i=>__, wb_rst_i=>__, wb_cyc_i=>__, wb_stb_i=>__, 
        ...
        spi_clk=>__, spi_miso=>__, spi_mosi=>__, spi_scsn=>__, spi_csn(0 downto 0)=>__, 
        spi_irq=>__, tc_clki=>__, tc_rstn=>__, tc_ic=>__, tc_int=>__, 
        tc_oc=>__, ufm_sn=>__, wbc_ufm_irq=>__);
