...
-- Module  Version: 1.1
--C:\ECAD\lscc\diamond\2.0\ispfpga\bin\nt64\scuba.exe -w -n efb_spi_wb -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 38 -spi -spi_mode Both -spi_en -spi_freq 5 -spi_cs 1 -wb -dev 7000 -e 

-- Mon Feb 03 17:08:06 2025
...
architecture Structure of efb_spi_wb is
...
begin
    ...
    EFBInst_0: EFB
        ...
        SPI_LSB_FIRST=> "DISABLED", SPI_CLK_DIVIDER=>  8, SPI_MODE=> "BOTH", 
        ...
        EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> "38.0")
