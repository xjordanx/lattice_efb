...
#define EFB_PLL1_BASE_ADDR		(0x20)	// PLL1 Dynamic Access1
#define EFB_I2C1_BASE_ADDR		(0x40)	// I2C Primary
#define EFB_I2C2_BASE_ADDR		(0x4A)	// I2C Secondary
#define EFB_SPI_BASE_ADDR		(0x54)	// SPI
#define EFB_TCNT_BASE_ADDR		(0x5E)	// Timer/Counter
#define EFB_UFMC_BASE_ADDR		(0x70)	// Flash Memory (UFM/Configuration)
#define EFB_INTR_BASE_ADDR		(0x76)	// EFB Interrupt Source
...
unsigned char efb_spi_init(
	...
	unsigned int stuff); // Must pick up here.
